   ...
   /**    //        KategorijeDao kategorijeDao = DaoFactory.kategorijeDao();
      ...
      //    List<Artikli> listaKategorija = new ArrayList<Artikli>(DaoFactory.artikliDao().getAll());
       ...
       // System.out.println( "Hello World!" );
        ...
        GnuParser commandLineParser = new GnuParser();//<- This may be the problem
        ...
        if((cl.hasOption(addArtikal.getOpt()) || cl.hasOption(addArtikal.getLongOpt())) && cl.hasOption((categoryDefinition.getLongOpt()))){
            ...
            try{
                kategorije = searchThroughCategories(kategorijeManager.getAll(), (String) cl.getArgList().get(1));
        ...
        artikal.setNaziv((String) cl.getArgList().get(0));
